      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
              <p><input type="submit" value="Phân quyền" class="btn btn-sm btn-success"></p>
              <p><a style="margin: 5px 0px;" class="btn btn-sm btn-danger" href="{{url('/delete-user-roles/'.$user->admin_id)}}">Xóa User</a></p>
            </td>
          </tr>
          </form>
          @endforeach
