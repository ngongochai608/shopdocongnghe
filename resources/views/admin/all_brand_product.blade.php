      ...
      <table class="table table-striped b-t b-light">
        <thead>
          <tr>
            ...
            <th colspan="3">Tên thương hiệu</th>
            <th colspan="3">Brand Slug</th>
        ...
        <tbody>
          ...
          <tr>
            <td colspan="2">{{$i}}</td>
            <td colspan="3">{{ $brand_pro->brand_name }}</td>
            <td colspan="3">{{ $brand_pro->brand_slug }}</td>
            <td colspan="2"><span class="text-ellipsis">
              <?php
            ...
            <td colspan="2">
              <a href="{{URL::to('/edit-brand-product/'.$brand_pro->brand_id)}}" class="active styling-edit" ui-toggle-class="">
                <i class="btn btn-success btn-xs fa fa-pencil-square-o text-success text-active" style="color: white;"> Sửa</i></a>
                &ensp;&ensp;&ensp;&ensp;
              <a onclick="return confirm('Bạn có chắc là muốn xóa danh mục này ko?')" href="{{URL::to('/delete-brand-product/'.$brand_pro->brand_id)}}" class="active styling-edit" ui-toggle-class="">
                <i class="btn btn-danger btn-xs fa fa-times text-danger text" style="color: white;"> Xóa</i>
              </a>
            </td>
          </tr>
          @endforeach
