            ...
            foreach($data['cart_qty'] as $key => $qty){
                foreach($cart as $session => $val){
                    if($val['session_id']==$key && $qty<$cart[$session]['product_quantity']){
                        ...
                        $message.='<p style="color:green;">Cập nhập số lượng cho <b>'.$cart[$session]['product_name'].'</b> thành công !</p>';
                    }
                    elseif($val['session_id']==$key && $qty>$cart[$session]['product_quantity']){
                        $message.='<p style="color:red;">Cập nhập số lượng cho <b>'.$cart[$session]['product_name'].'</b> thất bại . Vì số lượng đặt vượt quá số lượng trong kho !</p>';
                    }
                }
            }
            Session::put('cart',$cart);
