...
class OrderController extends Controller
{
	...
	public function print_order_convert($checkout_code){
		...
		<h4><center>Cửa hàng điện thoại smart</center></h4>
		<p>Người đặt hàng</p>
		...
		$output.= '<tr>
				<td colspan="2">
					...
					<p>Phí ship: '.number_format(25000,0,',','.').'đ'.'</p>
					<p>Thanh toán : '.number_format($total_coupon + 25000 ,0,',','.').'đ'.'</p>
				</td>
		</tr>';
		$output.='				
				</tbody>
		...
		<p>Ký tên</p>
			<table>
				<thead>
					<tr>
						<th width="200px">Người giao hàng</th>
