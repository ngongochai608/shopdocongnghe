...
class CategoryProduct extends Controller
{
    ...
    public function show_category_home(Request $request ,$slug_category_product){
        ...
        $category_by_id = DB::table('tbl_product')->join('tbl_category_product','tbl_product.category_id','=','tbl_category_product.category_id')->where('tbl_category_product.slug_category_product',$slug_category_product)->where('product_status','0')->get();
