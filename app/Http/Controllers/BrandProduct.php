...
class BrandProduct extends Controller
{
    ...
    //End Function Admin Page
     ...
     public function show_brand_home(Request $request, $brand_slug){
        ...
        $brand_by_id = DB::table('tbl_product')->join('tbl_brand','tbl_product.brand_id','=','tbl_brand.brand_id')->where('tbl_brand.brand_slug',$brand_slug)->where('product_status','0')->get();
